...
const titles = [
  ...
  ['Como Previnir', 'Dicas de Segurança', 'Procedimentos de Evacuação'],
  ['Localizar Desastres', 'Recursos de Emergência', 'Comunicar Riscos']
];

const texts = [
  [
    'Desastres naturais são eventos catastróficos causados por fenômenos naturais, como terremotos, furacões, enchentes, vulcões, secas e tsunamis, que resultam em danos significativos ao meio ambiente, infraestrutura e comunidades humanas. ',
    ...
    'Também conhecidos como tsunamis, são ondas gigantescas causadas por eventos subaquáticos, como terremotos. Essas ondas podem viajar a altas velocidades através dos oceanos e, ao se aproximarem da costa, aumentam de altura e podem causar devastação massiva. ',
  ],
  [
    ...
    'Familiarize-se com as rotas de evacuação e pontos de encontro designados. Mantenha a calma, evite o pânico e inicie a evacuação imediatamente. Use ferramentas de alertas de emergência.'
  ],
  [
